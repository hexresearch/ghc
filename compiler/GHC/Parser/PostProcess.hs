...
(checkExpBlockArguments, checkCmdBlockArguments) = (checkExpr, checkCmd)
  where
    ...
    checkExpr expr = case unLoc expr of
      ...
      HsLamCase _ lcVariant _ -> check (PsErrLambdaCaseInFunAppExpr lcVariant) expr
    ...
    checkCmd cmd = case unLoc cmd of
      ...
      HsCmdLamCase _ lcVariant _ -> check (PsErrLambdaCaseCmdInFunAppCmd lcVariant) cmd
...
instance DisambECP (PatBuilder GhcPs) where
  ...
  mkHsLamCasePV l lcVariant _ _ = addFatalError $ mkPlainErrorMsgEnvelope l (PsErrLambdaCaseInPat lcVariant)
