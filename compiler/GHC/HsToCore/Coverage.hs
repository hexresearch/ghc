...
addTickHsExpr (HsLamCase x lcVariant mgs) = liftM (HsLamCase x lcVariant)
...
addTickHsCmd (HsCmdLamCase x lcVariant mgs) =
        liftM (HsCmdLamCase x lcVariant) (addTickCmdMatchGroup mgs)
